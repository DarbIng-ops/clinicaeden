...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Mis Hospitalizaciones</h1>
        <p class="text-gray-600">Pacientes hospitalizados bajo mi cuidado médico</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Alta Médica</p>
                    <p class="text-2xl font-semibold text-gray-900">{{ $hospitalizaciones->where('estado', 'alta_medica')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $hospitalizaciones->where('estado', 'completado')->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('medico_general.hospitalizaciones.crear') }}" 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <a href="{{ route('medico_general.pacientes.show', $hospitalizacion->paciente) }}" 
                               class="text-green-600 hover:text-green-900">Paciente</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">No tienes hospitalizaciones registradas</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
