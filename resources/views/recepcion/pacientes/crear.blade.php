...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Registrar Nuevo Paciente</h1>
        <div class="space-x-2">
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('recepcion.pacientes.store') }}" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-6">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Foto (opcional) --}}
                    <div>
                        <label for="foto" class="block text-sm font-medium text-gray-700 mb-2">Foto <span class="text-gray-400 font-normal">(opcional)</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="direccion" name="direccion" rows="3" required
                                  ...
                                  placeholder="Av. Principal 123, Lima, Perú">{{ old('direccion') }}</textarea>
                        @error('direccion')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="ciudad" name="ciudad" value="{{ old('ciudad', 'Montevideo') }}" required
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="contacto_emergencia_nombre" name="contacto_emergencia_nombre" value="{{ old('contacto_emergencia_nombre') }}" required
                    ...
                    <div>
                        ...
                        <input type="tel" id="contacto_emergencia_telefono" name="contacto_emergencia_telefono" value="{{ old('contacto_emergencia_telefono') }}"
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('recepcion.pacientes.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-6 rounded-lg transition-colors">
                    Cancelar
                </a>
