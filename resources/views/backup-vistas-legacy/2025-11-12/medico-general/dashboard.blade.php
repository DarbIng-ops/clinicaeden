...
<div class="container mx-auto px-4 py-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <a href="{{ route('medico-general.pacientes.show', $hospitalizacion->paciente) }}" class="text-blue-600 hover:text-blue-900">Paciente</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <a href="{{ route('medico-general.pacientes.index') }}" class="flex flex-col items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
            ...
            <a href="{{ route('medico-general.consultas.index') }}" class="flex flex-col items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
            ...
            <a href="{{ route('medico-general.notificaciones.index') }}" class="flex flex-col items-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors">
