...
<div class="container mx-auto px-4 py-8">
        ...
        <div class="relative z-10 px-8 pt-8 pb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
                <div class="rounded-lg px-4 py-3" style="background:rgba(255,255,255,.12);">
                    <p class="text-2xl font-bold leading-tight">{{ $consultasPendientes->count() }}</p>
                    <p class="text-xs uppercase tracking-wide mt-1" style="opacity:.85;">Consultas Pendientes</p>
                </div>
                <div class="rounded-lg px-4 py-3" style="background:rgba(255,255,255,.12);">
                    <p class="text-2xl font-bold leading-tight">{{ $consultasHoy->count() }}</p>
                    <p class="text-xs uppercase tracking-wide mt-1" style="opacity:.85;">Atendidas Hoy</p>
                </div>
                <div class="rounded-lg px-4 py-3" style="background:rgba(255,255,255,.12);">
                    <p class="text-2xl font-bold leading-tight">{{ $pacientesHospitalizados->count() }}</p>
                    <p class="text-xs uppercase tracking-wide mt-1" style="opacity:.85;">Hospitalizados</p>
                </div>
                <div class="rounded-lg px-4 py-3" style="background:rgba(255,255,255,.12);">
                    <p class="text-2xl font-bold leading-tight">{{ $notificacionesNoLeidas }}</p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <a href="{{ route('medico_general.hospitalizaciones.crear') }}" class="flex flex-col items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
